...
public class CityLoader : MonoBehaviour {
    ...
    private const string AREAL_PATH = @"C:\Hackathon\rsg_hackathon2019_team6\Assets\Areal";
                ...
                //var area = collection.features[0];
            {
                if (area.properties.ContainsKey("path")) {
                    ...
                    foreach (var areaBuildings in areas.features) {
                        ...
                        //GameObjectUtility.SetStaticEditorFlags(lastObject, StaticEditorFlags.OccluderStatic);

                        //GameObjectUtility.SetStaticEditorFlags(lastObject.transform.GetChild(0).gameObject, StaticEditorFlags.OccluderStatic & StaticEditorFlags.LightmapStatic);
                        ...
                        var mesh = lastObject.GetComponentInChildren<MeshFilter>().sharedMesh;
